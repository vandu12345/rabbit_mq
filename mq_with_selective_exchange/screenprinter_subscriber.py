...
channel.queue_bind(exchange="log_exchange", queue=queue_name, routing_key='Warning')
channel.queue_bind(exchange="log_exchange", queue=queue_name, routing_key='Error')
channel.queue_bind(exchange="log_exchange", queue=queue_name, routing_key='Info')


print("Waiting For Message")

def callback(ch, method, properties, body):
    print('[x] Prining::::%r'%body)
